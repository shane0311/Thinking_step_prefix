...
if __name__ == "__main__":
    ...
    SCRIPT = "/home/pw58/efficient_reasoning/MUR/new_method/use_teacher_model_thinkingstep_prefix.py"
    ...
    for i in iterations:
        for prefix_len in thinking_step_prefix_len:
            for scale in scaling_rates:
                rel_file_stem = f"use_teacher_model-per_step_scale/gpqa_diamond/{i}/preifx_len_{prefix_len}"

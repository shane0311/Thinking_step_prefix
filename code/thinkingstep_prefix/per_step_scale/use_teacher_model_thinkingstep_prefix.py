        ...
        for step in range(args.max_steps):
            try:
                ...
                if args.thinking_step_prefix_length == 0:
                    ...
                    # Use teacher model to generate prefix
                    print(f"Teacher model generating prefix for question {idx}, step {step}")
                    ...
                    # Generate policy model prefix for comparison
                    ...
                    # Store both as candidates, use teacher's prefix as selected
                    prefix_candidates = [policy_prefix, teacher_prefix]
                    selected_prefix = teacher_prefix

                    # Complete step from teacher's prefix using policy model
